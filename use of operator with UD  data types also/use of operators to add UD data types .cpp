...
cin>>re>>im;
c2.setdata(re,im);
c3=c1+c2;  //read as c1 calls + function where it pass c2 as an arguement and the returned value is store in c3.



// Wouldnot it be so good if we were able to write c1+c2 directly, well in c++ that is also possible.
